...
// prepare SQL to retrieve subset of images
        ...
        <div id="gallery">
            <table id="thumbs">
                <tr>
					...
					// once loop begine, this in no longer true
					$firstRow = false;
					?>
            ...
            <div id="main_image">
                <p><img src="images/<?php echo $mainImage; ?>" alt="<?php echo $row['caption']; ?>" <?php echo $imageSize ?>></p>
